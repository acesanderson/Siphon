...
class TestFullIntegration:
    ...
    @pytest.mark.parametrize("source,expected_type,expected_uri_prefix", [
        ("https://github.com/owner/repo", SourceType.GITHUB, "github://"),
        ("https://youtube.com/watch?v=dQw4w9WgXcQ", SourceType.YOUTUBE, "youtube://"),
        ("https://docs.google.com/document/d/abc123/edit", SourceType.DRIVE, "drive://"),
